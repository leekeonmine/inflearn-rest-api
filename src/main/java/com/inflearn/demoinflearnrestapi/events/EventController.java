...
import com.inflearn.demoinflearnrestapi.events.common.ErrorsResource;
...
public class EventController {
    ...
    private ResponseEntity badRequest(Event event) {
        return ResponseEntity.badRequest().body(new ErrorsResource(event));
    }
}
